    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Right curve */}
          <div
            className="absolute top-0 h-full z-[3] pointer-events-none overflow-hidden"
            style={{ right: "-40px", width: "40px" }}
          >
            <div
              style={{
                position: "absolute",
                ...
                width: "80px",
                height: "100%",
                filter: "drop-shadow(3px 0 5px rgba(45,35,25,0.18))",
              }}
            >
              <svg
                viewBox="0 0 80 100"
              ...
              >
                <path
                  d="M 0 0 L 40 0 Q 80 50 40 100 L 0 100 Z"
                  fill={panelColor}
                />
              </svg>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M 80 0 L 40 0 Q 0 50 40 100 L 80 100 Z"
                  fill={panelColor}
                />
              </svg>
            </div>
